            ...
            <form action="${rootPath}/DeliveryUpdateAdmin.do" method="post" class="form_row">
                ...
                <div class="row">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                        <input type="radio" class="btn-check" name="state" id="state0" autocomplete="off" checked="" value="0">
                        <label class="btn btn-outline-primary" for="state0">배송전</label>
                        <input type="radio" class="btn-check" name="state" id="state1" autocomplete="off" checked="" value="1">
                        <label class="btn btn-outline-primary" for="state1">배송중</label>
                        <input type="radio" class="btn-check" name="state" id="state2" autocomplete="off" checked="" value="2">
                        <label class="btn btn-outline-primary" for="state2">배송 도착</label>
                        <input type="radio" class="btn-check" name="state" id="state3" autocomplete="off" checked="" value="3">
                        <label class="btn btn-outline-primary" for="state3">구매 확정</label>
                    </div>
